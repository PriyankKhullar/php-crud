            ...
            <div class="row">
                <div class="mbr-article mbr-article--wysiwyg col-sm-8 col-sm-offset-2">
                    ...
                    if (isset($_SESSION['user']['user_email'])){
                        ...
                        ?>
                        <!-- view like button -->
                        <?php echo $row['total_likes'] ?><a href="<?php echo SRC_PATH;?>template/single-post.php?post_id=<?php echo $row['id'] ?>&&user_id=<?php echo $user_id ?>" class="mbr-buttons__btn animated fadeInUp delay" name="like" href=""><i class="glyphicon glyphicon-thumbs-up" style="font-size: 30px; "></i></a>

                        <!-- view Comment button -->
                        <?php echo $row['total_comments'] ?><a class="mbr-buttons__btn animated fadeInUp delay" name="comment" href="<?php echo SRC_PATH; ?>template/comment.php?comment_id=<?php echo $id;?>"><i class="glyphicon glyphicon-comment" style="font-size: 30px; "></i></a>
 ...
 *  @param $key use as a values of array in which data stored.
 */
function showPostByCategoy($key)
{
    $id = $key['id'];
    ?>
    <section class="mbr-section" id="header3-78">
